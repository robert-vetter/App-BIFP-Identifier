...
public class BirdIdentifier extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bird_identifier);
    ...
    private void outputGenerator(Bitmap imageBitmap){
        try{
                BirdsData model = BirdsData.newInstance(BirdIdentifier.this);

                // Creates inputs for reference.
                TensorImage image = TensorImage.fromBitmap(imageBitmap);

                // Runs model inference and gets result.
                BirdsData.Outputs outputs = model.process(image);
