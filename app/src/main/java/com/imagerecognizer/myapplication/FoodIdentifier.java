...
import com.imagerecognizer.myapplication.ml.FoodModel;
...
public class FoodIdentifier extends AppCompatActivity {
    ...
    private void outputGenerator(Bitmap imageBitmap){
        try{
            FoodModel model = FoodModel.newInstance(FoodIdentifier.this);

            // Creates inputs for reference.
            TensorImage image = TensorImage.fromBitmap(imageBitmap);

            // Runs model inference and gets result.
            FoodModel.Outputs outputs = model.process(image);
