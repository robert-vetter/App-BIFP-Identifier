...
import com.imagerecognizer.myapplication.ml.BirdsData;
...
public class InsectIdentifier extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insect_identifier);
    ...
    private void outputGenerator(Bitmap imageBitmap){
        try{
            InsectModel model = InsectModel.newInstance(InsectIdentifier.this);

            // Creates inputs for reference.
            TensorImage image = TensorImage.fromBitmap(imageBitmap);

            // Runs model inference and gets result.
            InsectModel.Outputs outputs = model.process(image);
